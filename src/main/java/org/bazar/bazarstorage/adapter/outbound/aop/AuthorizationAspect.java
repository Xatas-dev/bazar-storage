...
import org.bazar.bazarstorage.app.service.AutherizationService;
...
public class AuthorizationAspect {
    ...
    private final AutherizationService authorizationService;
    ...
    public void checkAuthorization(JoinPoint joinPoint, Authorize authorize) {
        ...
        if (!isAllowed) {
            log.error("Auth denied: permission {}, user {}, space {}", authorize.permission(),
                    ...
                    spaceId);
            throw new BusinessException(AUTH_DENIED);
        }
    }
